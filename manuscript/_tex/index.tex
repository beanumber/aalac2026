...
\begin{center}
  {\LARGE\bf Generative AI hasn't changed learning: It's still hard to
become an expert}
\end{center}
\smallskip
...
\begin{multicols}{4}
\textbf{Ming-Wen An}\\
  Mathematics and Statistics\\Vassar College\\
\\[0.6em]
\textbf{Benjamin S. Baumer}\\
  Statistical and Data Sciences\\Smith College\\
\\[0.6em]
\textbf{Logan Dancey}\\
  Government\\Wesleyan University\\
\\[0.6em]
\textbf{Richard De Veaux}\\
  Statistics\\Williams College\\
\\[0.6em]
\textbf{Daryl DeFord}\\
  Mathematics and Statistics\\Vassar College\\
\\[0.6em]
\textbf{Erika Franklin Fowler}\\
  Government\\Wesleyan University\\
\\[0.6em]
\textbf{Stephen Freund}\\
  Computer Science\\Williams College\\
\\[0.6em]
\textbf{Sorelle Friedler}\\
  Computer Science\\Haverford College\\
\\[0.6em]
\textbf{Maryam Gooyabadi}\\
  Hazel Quantitative Analysis Center\\Wesleyan University\\
\\[0.6em]
\textbf{Douglas Hall}\\
  Academic Technology Services\\Amherst College\\
\\[0.6em]
\textbf{Brianna Heggeseth}\\
  Mathematics, Statistics, and Computer Science\\Macalester College\\
\\[0.6em]
\textbf{Nicholas J. Horton}\\
  Statistics\\Amherst College\\
\\[0.6em]
\textbf{Emmanuel Kaparakis}\\
  Hazel Quantitative Analysis Center\\Wesleyan University\\
\\[0.6em]
\textbf{Antonio Laverghetta Jr.}\\
  Hazel Quantitative Analysis Center\\Wesleyan University\\
\\[0.6em]
\textbf{Victoria Manfredi}\\
  Computer Science\\Wesleyan University\\
\\[0.6em]
\textbf{Valerie Nazzaro}\\
  Hazel Quantitative Analysis Center\\Wesleyan University\\
\\[0.6em]
\textbf{Thao Nguyen}\\
  Computer Science\\Haverford College\\
\\[0.6em]
\textbf{Cassandra Pattanayak}\\
  Quantitative Analysis Institute\\Wellesley College\\
\\[0.6em]
\textbf{Anna Plantinga}\\
  Statistics\\Williams College\\
\\[0.6em]
\textbf{Alex Reinhart}\\
  Statistics and Data Science\\Carnegie Mellon University\\
\\[0.6em]
\textbf{Lynne Steuerle Schofield}\\
  Mathematics and Statistics\\Swarthmore College\\
\\[0.6em]
\textbf{Marc Schulz}\\
  Psychology\\Bryn Mawr College\\
\\[0.6em]
\textbf{Sarah Supp}\\
  Data Analytics and Sustainability and Environmental Studies\\Denison
University\\
\\[0.6em]
\textbf{Anjali Thapar}\\
  Psychology\\Bryn Mawr College\\
\\[0.6em]
\textbf{Elizabeth Upton}\\
  Statistics\\Williams College\\
\\[0.6em]
\textbf{Zhe Wang}\\
...
\noindent%
{\it Keywords:} Generative AI, higher education, learning science, data
science education
\vfill
...
excellent employment prospects relative to their peers
\citep{gray2025measuring}, their employability is as much a by-product
of a well-rounded, humanistic education as it is an end in itself.
Setting students up to have better options and make better choices is a
foreground priority.
...
and others that make them such valuable employees \citep{holmes2026ai}.
Rather than being confined to a single application, their skills
...
interact \citep{disessa1982unlearning, schauble1991causal}. This is true
for everyone: the doctor and the medical assistant, the receptionist and
the executive, the plumber and the chemist. These mental models allow
people to employ causal reasoning, such as making a prediction about
what will happen and then testing that prediction against reality, an
act that may result in an update to the mental model. The more accurate
the mental model of the system, the more competent the professional is.
...
tasks become automated \citep{van2010cognitive}. Learning is the result
of this automation. Think of the way you can brush your teeth, tie your
shoes, or work the foot pedals in a car without thinking about what you
are doing, or further, while thinking about something else entirely.
Building these automated schemas requires deliberate, repeated practice
...
the tasks that we ask our introductory statistics students to do
\citep{deluca2025developing, lu2025stateval}.
...
An analogy to music might help. GenAI amplifies existing skills
\citep{wickham2026ai} the same way an incredible new amp could have
expanded Jimi Hendrix's or B. B. King's (possibly two of the greatest
guitarists to ever play) sounds and techniques in a way that would have
been prohibitively expensive in terms of time, money, or both when they
were alive. However, for the novice who is just learning to play, having
a fancy amp might be cool, but it doesn't really help them play any
better. The evidence for the efficacy of GenAI-based tutoring is mixed
at best \citep{kestin2025ai, bastani2025generative}, and there is simply
no substitute for good old-fashioned practice \citep{ericsson2016peak}.
...
\citep{willingham2008critical, pithers2000critical, tricot2014domain}.
That is, students need both fundamental disciplinary knowledge and
domain expertise in order to apply critical thinking. Thus, it's not
possible to think critically about a regression model for home sales
until you know something about regression models \emph{and} something
about the real estate market. You can't be
...
would require strong experimental evidence (which is scant
\citep{gerlich2025ai}), and if you accept our analogy, they defy logic.
As educators, we have been helping students develop foundational skills
much in the manner that music teachers have: first we explain, then we
demonstrate, then students practice and receive feedback. As any music
teacher will tell you, this process doesn't work if students don't build
muscle memory (i.e., automate their schema) through practice. For many
...
true for novices \citep{daniotti2026using}. By definition, novices don't
...
even while their assessed performance is declining
\citep{prather2023s, prather2024widening, fan2025beware}. These insights
help to explain why novices often end up chasing their tail when using
GenAI.
...
a far more important quality for their long-term success
\citep{liu2026ai}. Novices who rely heavily on GenAI assistance may also
fail to cultivate the mentoring and peer relationships that reinforce
learning and propel them into future career success
\citep{silva2025ai, hou2025all}---relationships which experts have
already had the time and experience to develop. As they become more
dependent on GenAI, students concomitantly become less likely to seek
out human-centric supports for learning (e.g., office hours, tutoring,
study groups, etc.), leaving them even more isolated and disconnected
from their learning community \citep{hou2025all, glickman2026tutor}.
...
role in their future careers \citep{imundo2024expert}.
...
that GenAI promises. Students are beginning to realize this
\citep{gaines2026ai, schwartz2026more}, and we observe increasing signs
of their resentment towards GenAI, in the
...
against AI}, and outright refusal to use AI \citep{mcmurtrie2025ai}.
Rather than using GenAI because they see it as the best tool for their
learning, many students report feeling compelled \citep{yang2026ai} to
use GenAI due to shifting norms, competition with peers, stress,
...
education and GenAI's role within it \citep{mit2026ai}. This will
require realignment from all parties, most notably including students
and faculty. The remainder of this paper addresses four key
...
of GenAI that experienced professionals report \citep{gates2026ai}.
